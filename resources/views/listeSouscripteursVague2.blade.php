			  ...
			  <div class="col s12"><br>
			  	<div class="card z-depth-5 col s12">
			  	 ...
			  	 <ul id="dropdown5" class="dropdown-content " style="height:40px;line-height:40px">
                      <li>
                      	<a href="{!! url('souscripteurs/preselectionne2/listepdf') !!}" style="font-size:18px;">
                      ...
                      <li>
                      		<a href="{!!url('souscripteurs/preselectionne2/listeexcel') !!}" style="font-size:18px">
			                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20pt" height="20pt" viewBox="0 0 20 20" version="1.1">
									<g id="surface1">
				...
				<div class="row" >
					 <div class="col s12" style="margin-top:50px">
		    				<a class="dropdown-trigger  waves-light green btn-large" href="#!" data-target="dropdown5" style="margin-right:100px;margin-bottom:20;">Exporter en <i class="material-icons right">arrow_drop_down</i></a>
			  				<a style="width:350px;margin-bottom:20;"class="dropdown-trigger  waves-light green btn-large" href="#!" data-target="dropdown6" >Liste des souscripteurs <i class="material-icons right">arrow_drop_down</i></a>
		  			</div>
		  		</div>
			  		<h4>Liste des souscripteurs 2ème catégorie</h4>	  
			  		<h5>Nombre total: {{ $nbSouscripteur }}</h5>
				  <br>
				  <table class="responsive-table">
		 			...
		 			@foreach($souscripteurs as $souscripteur)
		 			 	...
		 			 	@if($souscripteur->etat=="non formé")
		 			 		<tr>
								...
								<td>
									...
									@if($souscripteur->energie==1)
										-Energie
									@endif
									@if($souscripteur->connaissance!=null)
										{!! $souscripteur->connaissance !!}
									@endif
								</td>
								<td>
									@if($souscripteur->cnib==null)
										pas de fichier joint
									@else
									<div class="row">
									 <a class="waves-effect waves-light btn-small" title="Voir le fichier joint" href="{!! url('uploads',$souscripteur->cnib) !!}"><i class="material-icons center">cloud_download</i></a>
					  				</div>
					  				@endif
					  			</td>
					  			<td>
									@if($souscripteur->diplome==null)
										pas de fichier joint
									@else
									<div class="row">
									 <a class="waves-effect waves-light btn-small" title="Voir le fichier joint" href="{!! url('uploads',$souscripteur->diplome) !!}"><i class="material-icons center">cloud_download</i></a>
					  				</div>
					  				@endif
					  			</td>
					  			<td>
									@if($souscripteur->attestation==null)
										pas de fichier joint
									@else
									<div class="row">
									 <a class="waves-effect waves-light btn-small" title="Voir le fichier joint" href="{!! url('uploads',$souscripteur->attestation) !!}"><i class="material-icons center">cloud_download</i></a>
					  				</div>
					  				@endif
					  			</td>
					  			<td>
									@if($souscripteur->autreDocument==null)
										pas de fichier joint
									@else
									<div class="row">
									 <a class="waves-effect waves-light btn-small" title="Voir le fichier joint" href="{!! url('uploads',$souscripteur->autreDocument) !!}"><i class="material-icons center">cloud_download</i></a>
					  				</div>
					  				@endif
					  			</td>
								...
								<td>
									<div class="row">
								      	<a class="waves-effect waves-light btn-small" title="Formé" href="{!! url('selection2',$souscripteur->id) !!}"><i class="material-icons center">check_circle</i></a>
					  				</div>
					  			</td>
							</tr>
							@endif
