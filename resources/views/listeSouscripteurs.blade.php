			  ...
			  <div class="col s12"><br>
			  	<div class="card z-depth-5 col s12">
		  		 ...
		  		 <ul id="dropdown5" class="dropdown-content " style="height:40px;line-height:40px">
                      <li>
                      	<a href="{!! url('souscripteurs/listepdf') !!}" style="font-size:18px;">
                      ...
                      <li>
                      		<a href="{!!url('souscripteurs/listeexcel') !!}" style="font-size:18px">
			                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20pt" height="20pt" viewBox="0 0 20 20" version="1.1">
									<g id="surface1">
		 			 ...
		 			 @foreach($souscripteurs as $souscripteur)
		 			 		<tr>
								...
								<td>
					  			...
					  			<td>
					  				@if($souscripteur->codeValidation!=null)
										code:{{ $souscripteur->codeValidation }}
									@else
									@if($souscripteur->numeroQuittance!=null)
										N° quittance:{{ $souscripteur->numeroQuittance }}
									@else
									@if($souscripteur->subvention!=null)
										N° subvention:{{ $souscripteur->subvention }}
									@else
											---
									@endif	
									@endif
